...
async function aUST_process(insufficientUST: number){
    let aUST_balance: number = await fetchAPI.aUST_balance(myAddress)
    let exchange_rate: number = await fetchAPI.aUST_exchange_rate()
